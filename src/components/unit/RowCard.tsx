// src/components/unit/RowCard.tsx
"use client";
import Image from "next/image";
import Link from "next/link";
import type { MovieListItem, TVListItem } from "@/types/tmdb";

function titleOf(i: MovieListItem | TVListItem) {
  return (i as MovieListItem).title ?? (i as TVListItem).name ?? "Untitled";
}
      ...
      >
        {url ? (
          <Image
            ...
            // Tell Next how wide each card is at each breakpoint
            sizes="
