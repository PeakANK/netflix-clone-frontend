...
// Details via Next proxy (same-origin, no CORS)
export const getMovieDetails = (id: number) => apiGet<MovieDetail>("/api/movie", { id });
export const getTVDetails = (id: number) => apiGet<TVDetail>("/api/tv", { id });      
